...
theme (это ЗАГОЛОВОК НА КАРТИНКЕ) — короткий, про суть/настроение/приглашение. НЕ указывай в нём конкретную температуру в °C — она уже показана в погодном виджете сверху, дубль смотрится как ошибка.
...
theme (ЗАГОЛОВОК НА КАРТИНКЕ) — короткий, БЕЗ конкретной температуры в °C (она уже в виджете сверху — не дублируй).
