...
${roleBlock}
${ctx.promoBlock ? '\nПРО СКИДКИ: упоминай ТОЛЬКО скидки из блока «ДЕЙСТВУЮЩИЕ СКИДКИ» выше — они реально заведены в системе. НЕ выдумывай акции, проценты и спеццены, которых там нет. Подавай мягко, без давления, цену — числом из блока. Если скидок в блоке нет — про скидки молчи.\n' : ''}
${RF_LAW_RULE}
