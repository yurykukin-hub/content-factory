...
- [~] PostEditorView уже умеет: редактировать/адаптировать/публиковать non-story посты (TEXT/PHOTO/REELS), редирект STORIES→StoryEditor.
- [ ] B2 смена типа в редакторе · B4 IG Reels UI-валидация · B5 VK Клипы (нужен API research) · B6 TG видео
