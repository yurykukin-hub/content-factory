...
## В работе / осталось
- **▶ СЛЕДУЮЩАЯ СЕССИЯ = Фаза D** (последняя крупная; готовый промпт для plan-режима: `docs/refactor/NEXT-SESSION-PHASE-D.md`). **Сначала реши деплой** C3+фиксов — баг edit-image сломан В ПРОДЕ (Света/Антон, сезон), деплой по команде «деплой».
