...
│   │   │   ├── promo/          # Промо (Фаза 3): red-lines.ts (getRedLine — красные линии маржи, переиспуч. Sales Bot) + promo-block.ts (buildPromoBlock — действующие скидки в промпт дайджеста)
│   │   │   └── publishers/
