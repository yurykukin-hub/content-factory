...
- Если в промпте есть теги @Image1, @Image2 и т.д. — это ССЫЛКИ на референс-изображения. ОБЯЗАТЕЛЬНО сохрани каждый тег в выходном промпте. Вставь тег сразу после первого упоминания соответствующего объекта. НЕ удаляй, не изменяй и не пропускай теги @ImageN
