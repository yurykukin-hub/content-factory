...
import {
  Building2, Plus, Loader2, FileText, ClipboardList, ChevronRight
...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold">Бизнесы</h1>
      <button
        v-if="isAdmin"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div
        ...
        class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 cursor-pointer hover:border-brand-400 dark:hover:border-brand-600 hover:shadow-md transition-all group"
      >
        <div class="flex items-start justify-between mb-3">
          ...
          <ChevronRight :size="18" class="text-gray-300 group-hover:text-brand-500 transition-colors mt-1" />
        </div>
